...
<head>
    ...
    <link rel="canonical" href=".<?php echo ASSETS_URL_ROOT . '/' ?>home" />
    ...
    <link rel="shortcut icon" href="<?php echo ASSETS_URL_ROOT . '/public/' ?>assets/storage/images/favicon_V01.ico"
        type="image/x-icon">
    <link rel="stylesheet"
    ...
    <div class="wrapper">
        <div class="iq-sidebar sidebar-default">
            ...
            <div class="iq-sidebar-logo d-flex align-items-end justify-content-between">
                <a href="<?php echo ASSETS_URL_ROOT . '/' ?>home" class="header-logo">
            ...
            <div class="data-scrollbar" data-scroll="1">
                <nav class="iq-sidebar-menu">
                    ...
                    <ul id="iq-sidebar-toggle" class="side-menu">
                                    ...
                                    <div class=" p-0 ">
                                        <ul class="dropdown-menu-1 list-group list-group-flush">
                                            <li onclick="changeLanguage(8)"
                                                class="dropdown-item-1 list-group-item px-2"><a class="p-0" href="#"
                                                    style="color: #8f9fbc;"><img
                                                        src="<?php echo ASSETS_URL_ROOT . '/public/' ?>assets/storage/flags/flag_Vietnamese.png"
                                            ...
                                            <li onclick="changeLanguage(16)"
                                                class="dropdown-item-1 list-group-item px-2"><a class="p-0" href="#"
                                                    style="color: #8f9fbc;"><img
                                                        src="<?php echo ASSETS_URL_ROOT . '/public/' ?>assets/storage/flags/flag_English.png"
                                                        alt="img-flaf" class="img-fluid mr-2"
                        ...
                        <li class=" sidebar-layout">
                            <a href="<?php echo ASSETS_URL_ROOT . '/' ?>home" class="svg-icon ">
                                <i class="fas fa-shopping-cart"></i>
                                <span class="ml-2">MUA TÀI KHOẢN</span>
                            </a>
                        </li>
                        <li class=" sidebar-layout">
                            <a href="<?php echo ASSETS_URL_ROOT . '/' ?>shop_document" class="svg-icon ">
                                <i class="fas fa-book"></i>
                                <span class="ml-2">MUA TÀI LIỆU</span>
                            </a>
                        </li>
                        <li class=" sidebar-layout">
                            <a href="<?php echo ASSETS_URL_ROOT . '/' ?>order" class="svg-icon ">
                        ...
                        <li class=" sidebar-layout">
                            <a href="<?php echo ASSETS_URL_ROOT . '/' ?>recharge" class="svg-icon ">
                                <i class="fas fa-university"></i>
                                <span class="ml-2">Ngân Hàng</span>
                            </a>
                        </li>
                        <li class=" sidebar-layout">
                            <a href="<?php echo ASSETS_URL_ROOT . '/' ?>invoices" class="svg-icon ">
                            ...
                            <ul class="navbar-nav ml-auto navbar-list align-items-center">
                                ...
                                <li class="nav-item nav-icon dropdown">
                                    <a href="#" class="nav-item nav-icon dropdown-toggle pr-0 search-toggle"
                                        ...
                                        aria-expanded="false">
                                        <img src="<?php echo ASSETS_URL_ROOT . '/public/' ?>public/datum/assets/images/user/1.jpg"
        ...
        <script defer src="<?php echo ASSETS_URL_ROOT . '/public/' ?>public/datum/assets/js/backend-bundle.min.js">
        </script>
        <!-- Chart Custom JavaScript -->
        <script defer src="<?php echo ASSETS_URL_ROOT . '/public/' ?>public/datum/assets/js/customizer.js"></script>
        <script defer src="<?php echo ASSETS_URL_ROOT . '/public/' ?>public/datum/assets/js/sidebar.js"></script>
        <!-- Flextree Javascript-->
        <script defer src="<?php echo ASSETS_URL_ROOT . '/public/' ?>public/datum/assets/js/flex-tree.min.js"></script>
        <script defer src="<?php echo ASSETS_URL_ROOT . '/public/' ?>public/datum/assets/js/tree.js"></script>
        <!-- Table Treeview JavaScript -->
        <script defer src="<?php echo ASSETS_URL_ROOT . '/public/' ?>public/datum/assets/js/table-treeview.js"></script>
        <!-- SweetAlert JavaScript -->
        <script defer src="<?php echo ASSETS_URL_ROOT . '/public/' ?>public/datum/assets/js/sweetalert.js"></script>
        <!-- Vectoe Map JavaScript -->
        <script defer src="<?php echo ASSETS_URL_ROOT . '/public/' ?>public/datum/assets/js/vector-map-custom.js">
        </script>
        <!-- Chart Custom JavaScript -->
        <script defer src="<?php echo ASSETS_URL_ROOT . '/public/' ?>public/datum/assets/js/chart-custom.js"></script>
        <script defer src="<?php echo ASSETS_URL_ROOT . '/public/' ?>public/datum/assets/js/charts/01.js"></script>
        <script defer src="<?php echo ASSETS_URL_ROOT . '/public/' ?>public/datum/assets/js/charts/02.js"></script>
        <!-- slider JavaScript -->
        <script defer src="<?php echo ASSETS_URL_ROOT . '/public/' ?>public/datum/assets/js/slider.js"></script>
        <!-- Emoji picker -->
        <script defer
            src="<?php echo ASSETS_URL_ROOT . '/public/' ?>public/datum/assets/vendor/emoji-picker-element/index.js"
            type="module"></script>
        <!-- app JavaScript -->
        <script defer src="<?php echo ASSETS_URL_ROOT . '/public/' ?>public/datum/assets/js/app.js"></script>