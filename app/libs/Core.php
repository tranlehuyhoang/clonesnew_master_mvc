...
class Core
{
    ...
    {
        $exit_controller = array('abouts', 'admin', 'blog', 'cart', 'checkout', 'contact', 'profile_user', 'orders_detail', 'home', 'payment', 'invoices', 'posts', 'recharge', 'order', 'products', 'user', 'wishlist', 'login', 'shop_document', 'register');
